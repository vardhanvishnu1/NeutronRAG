...
**Deployed App:** [https://neutronrag.streamlit.app/](https://neutronrag.streamlit.app/)
...
* **Intelligent Build**: Automatically compiles C++ source code to match the host environment—whether on Mac or the Cloud.
...
## 🛠️ Technical Stack
* **Languages**: Python & C++11
* **AI Models**: Google Gemini API & Sentence-Transformers
* **Framework**: Streamlit
* **Interface**: `pybind11`
